...
const getEmailVerificaitonText = function (param) {
  ...
  <table style="margin:0 auto;padding:0;width:100%;max-width:630px;font-family:'Noto Sans KR', 'Nanum Gothic', 'Roboto', 'Malgun Gothic', sans-serif" cellspacing="0" cellpadding="0">
  <tbody>
  <tr style="background-color:#f3f9f6;height:50px">
  <td style="vertical-align:middle;padding-left:10px;padding-top:5px;"><a href="https://www.pedagy.com" style="font-family:'Roboto', sans-serif; height:40px;display:inline-block;text-decoration:none;" ><img src="https://www.pedagy.com/img/logo.svg" alt="Pedagy"></a></td>
  </tr>
  <tr>
  ...
  <tbody>
  <tr>
  <td style="padding:27px 0 17px;font-size:30px;line-height:34px;color:#333"><strong style="color:#9dd1b7;font-weight:normal">이메일 계정 인증</strong>안내</td>
  </tr>
  <tr>
  ...
  <a href="https://www.pedagy.com/${param}" style="border-radius:none;border:1px solid #9dd1b7;cursor:pointer;color:#fff;text-align:center;font-size:1.2rem;display:inline-block;background-color:#9dd1b7;font-family:'Noto Sans KR', 'Nanum Gothic', 'Roboto', 'Malgun Gothic', sans-serif;font-weight:normal;text-decoration:none; padding:12px 30px;"><span style="height:40px;">인증하기</span></a>
  </td>
  </tr>
  <tr>
  ...
  © <a href="https://www.pedagy.com" style="color:#666;text-decoration:none">Pedagy</a></td>
  </tr>
  </tbody>
  </table>
  </td>
...
const getPasswordResetText = function (newPassword) {
  ...
  <tbody>
  <tr>
  <td style="padding:27px 0 17px;font-size:30px;line-height:34px;color:#333"><strong style="color:#9dd1b7;font-weight:normal">임시비밀번호 발급</strong>안내</td>
  </tr>
  <tr>
